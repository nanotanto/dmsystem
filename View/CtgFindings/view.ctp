<div class="ctgFindings view">
<h2><?php echo __('Ctg Finding'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($ctgFinding['CtgFinding']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($ctgFinding['CtgFinding']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Description'); ?></dt>
		<dd>
			<?php echo h($ctgFinding['CtgFinding']['description']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
...
<div class="related">
	...
	<?php if (!empty($ctgFinding['RecAudit'])): ?>
	...
	<?php foreach ($ctgFinding['RecAudit'] as $recAudit): ?>
		<tr>
