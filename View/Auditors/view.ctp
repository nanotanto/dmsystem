...
<h2><?php echo __('Auditor'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($auditor['Auditor']['name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Auditor'), array('action' => 'delete', $auditor['Auditor']['id']), array(), __('Are you sure you want to delete # %s?', $auditor['Auditor']['id'])); ?> </li>
		...
		<li><?php echo $this->Html->link(__('List Rec Audits'), array('controller' => 'rec_audits', 'action' => 'index')); ?> </li>
...
<div class="related">
	...
	<?php foreach ($auditor['RecAudit'] as $recAudit): ?>
		<tr>
