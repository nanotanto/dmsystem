<div class="requirements index">
	...
	<tr>
		...
		<td><?php echo h($requirement['Requirement']['description']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $requirement['Requirement']['id']), array(), __('Are you sure you want to delete # %s?', $requirement['Requirement']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
